...
/*------------------------------------------------------------------------	
# mod_responsivegallery - Responsive Photo Gallery for Joomla 3.x v2.9.2	
# ------------------------------------------------------------------------	
...
$flickrGallery		= $params->get('flickrGallery');	
...
?>
	...
	<?php if ($imageFeed == "4"): ?>
		...
		<?php if ($styles == "custom"): ?>
			<style type="text/css">
				...
				.rg-image-nav a {background-color: <?php echo $params->get('backgroundSkin') ?> !important; background-image: ("../images/nav.png") !important;}
				.es-carousel {background-color: <?php echo $params->get('backgroundSkin') ?> !important;}
				.es-carousel-wrapper {background-color: <?php echo $params->get('backgroundSkin') ?> !important; border-radius: <?php echo $params->get('borderRadius') ?>;}
				.rg-caption p {color: <?php echo $params->get('textColor') ?> !important;}
			</style>
		<?php endif ; ?>
				<?php if ($autoPlay == "autoplayYes") : ?>
	...
	if ($picasaTitle == "3") {
		...
		if ($value['title'] != "") {
						echo "<ul>";
				echo "<li>";
		echo "<a href=\"#\"><img src=\"" . $value['thumbnail']  . "\" data-large=\"" . $value['picture']  . "\" alt=\"" . $value['title'] . "\" data-description=\"" . $value['caption'] . "" . $picasaTag . "\" data-href=\"" . $value['picture']  . "\"></a>";
				echo "</li>";
						echo "</ul>";
							}
						}
	...
	<ul>
		<?php if ($params->get('img1url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img1url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img1url') ?>" alt="<?php echo $params->get('img1title') ?>" data-description="<?php echo $params->get('img1title') ?>" data-href="<?php echo $params->get('img1url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img2url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img2url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img2url') ?>" alt="<?php echo $params->get('img2title') ?>" data-description="<?php echo $params->get('img2title') ?>" data-href="<?php echo $params->get('img2url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img3url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img3url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img3url') ?>" alt="<?php echo $params->get('img3title') ?>" data-description="<?php echo $params->get('img3title') ?>" data-href="<?php echo $params->get('img3url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img4url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img4url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img4url') ?>" alt="<?php echo $params->get('img4title') ?>" data-description="<?php echo $params->get('img4title') ?>" data-href="<?php echo $params->get('img4url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img5url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img5url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img5url') ?>" alt="<?php echo $params->get('img5title') ?>" data-description="<?php echo $params->get('img5title') ?>" data-href="<?php echo $params->get('img5url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img6url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img6url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img6url') ?>" alt="<?php echo $params->get('img6title') ?>" data-description="<?php echo $params->get('img6title') ?>" data-href="<?php echo $params->get('img6url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img7url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img7url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img7url') ?>" alt="<?php echo $params->get('img7title') ?>" data-description="<?php echo $params->get('img7title') ?>" data-href="<?php echo $params->get('img7url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img8url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img8url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img8url') ?>" alt="<?php echo $params->get('img8title') ?>" data-description="<?php echo $params->get('img8title') ?>" data-href="<?php echo $params->get('img8url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img9url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img9url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img9url') ?>" alt="<?php echo $params->get('img9title') ?>" data-description="<?php echo $params->get('img9title') ?>" data-href="<?php echo $params->get('img9url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img10url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img10url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img10url') ?>" alt="<?php echo $params->get('img10title') ?>" data-description="<?php echo $params->get('img10title') ?>" data-href="<?php echo $params->get('img10url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img11url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img11url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img11url') ?>" alt="<?php echo $params->get('img11title') ?>" data-description="<?php echo $params->get('img11title') ?>" data-href="<?php echo $params->get('img11url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img12url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img12url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img12url') ?>" alt="<?php echo $params->get('img12title') ?>" data-description="<?php echo $params->get('img12title') ?>" data-href="<?php echo $params->get('img12url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img13url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img13url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img13url') ?>" alt="<?php echo $params->get('img13title') ?>" data-description="<?php echo $params->get('img13title') ?>" data-href="<?php echo $params->get('img13url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img14url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img14url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img14url') ?>" alt="<?php echo $params->get('img14title') ?>" data-description="<?php echo $params->get('img14title') ?>" data-href="<?php echo $params->get('img14url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img15url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img15url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img15url') ?>" alt="<?php echo $params->get('img15title') ?>" data-description="<?php echo $params->get('img15title') ?>" data-href="<?php echo $params->get('img15url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img16url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img16url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img16url') ?>" alt="<?php echo $params->get('img16title') ?>" data-description="<?php echo $params->get('img16title') ?>" data-href="<?php echo $params->get('img16url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img17url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img17url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img17url') ?>" alt="<?php echo $params->get('img17title') ?>" data-description="<?php echo $params->get('img17title') ?>" data-href="<?php echo $params->get('img17url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img18url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img18url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img18url') ?>" alt="<?php echo $params->get('img18title') ?>" data-description="<?php echo $params->get('img18title') ?>" data-href="<?php echo $params->get('img18url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img19url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img19url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img19url') ?>" alt="<?php echo $params->get('img19title') ?>" data-description="<?php echo $params->get('img19title') ?>" data-href="<?php echo $params->get('img19url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img20url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img20url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img20url') ?>" alt="<?php echo $params->get('img20title') ?>" data-description="<?php echo $params->get('img20title') ?>" data-href="<?php echo $params->get('img20url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img21url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img21url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img21url') ?>" alt="<?php echo $params->get('img21title') ?>" data-description="<?php echo $params->get('img21title') ?>" data-href="<?php echo $params->get('img21url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img22url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img22url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img22url') ?>" alt="<?php echo $params->get('img22title') ?>" data-description="<?php echo $params->get('img22title') ?>" data-href="<?php echo $params->get('img22url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img23url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img23url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img23url') ?>" alt="<?php echo $params->get('img23title') ?>" data-description="<?php echo $params->get('img23title') ?>" data-href="<?php echo $params->get('img23url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img24url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img24url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img24url') ?>" alt="<?php echo $params->get('img24title') ?>" data-description="<?php echo $params->get('img24title') ?>" data-href="<?php echo $params->get('img24url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img25url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img25url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img25url') ?>" alt="<?php echo $params->get('img25title') ?>" data-description="<?php echo $params->get('img25title') ?>" data-href="<?php echo $params->get('img25url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img26url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img26url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img26url') ?>" alt="<?php echo $params->get('img26title') ?>" data-description="<?php echo $params->get('img26title') ?>" data-href="<?php echo $params->get('img26url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img27url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img27url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img27url') ?>" alt="<?php echo $params->get('img27title') ?>" data-description="<?php echo $params->get('img27title') ?>" data-href="<?php echo $params->get('img27url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img28url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img28url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img28url') ?>" alt="<?php echo $params->get('img28title') ?>" data-description="<?php echo $params->get('img28title') ?>" data-href="<?php echo $params->get('img28url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img29url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img29url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img29url') ?>" alt="<?php echo $params->get('img29title') ?>" data-description="<?php echo $params->get('img29title') ?>" data-href="<?php echo $params->get('img29url') ?>" /></a>
			</li><?php } ?>
		<?php if ($params->get('img30url') != "") { ?>
			<li><a href="#"><img style="width:<?php echo $params->get('galThumbratio') ?>;height:<?php echo $params->get('galThumbratio') ?>;margin-top:-30px;" src="<?php echo $params->get('img30url') ?>" data-large="<?php echo $LiveSite ?><?php echo $params->get('img30url') ?>" alt="<?php echo $params->get('img30title') ?>" data-description="<?php echo $params->get('img30title') ?>" data-href="<?php echo $params->get('img30url') ?>" /></a>
			</li><?php } ?>
	</ul>
	</div>
								</div>
