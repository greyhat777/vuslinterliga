...
class JoomsportViewseason_edit extends JViewLegacy
{
	var $_model = null;
	...
	protected function addToolbar($edit)
	{
		...
		JToolBarHelper::title( JText::_( 'BLBE_MENSEASON' ).': <small><small>[ '. $text.' ]</small></small>', 'tourn.png' );
		...
		if(substr($joomla_v,0,3) >= '1.7'){
			JToolBarHelper::save2new('season_save_new');
		}else{
			JToolBarHelper::save('season_save_new',JText::_("JSTOOL_SAVE_NEW"));
		}
		JToolBarHelper::cancel('season_list');
