...
class edit_matchJSModel extends JSPRO_Models
{
	...
	function getData()
	{
		...
		$this->_lists['extra'] 		= JHTML::_('select.booleanlist',  'is_extra', 'class="inputbox" '.$javascriptus, $row->is_extra );
	...
	function getMVenue($venue_id){
		...
		$this->_lists['venue'] = JHTML::_('select.genericlist',   $is_venue, 'venue_id', 'class="styled-long" size="1"', 'id', 'v_name', $venue_id);
	}
	...
	function getMdfilter($m_id){
		...
		$this->_lists['mday'] = JHTML::_('select.genericlist',   $mdayis, 'm_id', 'class="inputbox" size="1"', 'id', 'm_name', $m_id);
	...
	function getParticipiant(& $row){
		...
		$this->_lists['sel_team'] = JHTML::_('select.genericlist',   $is_team2, 'teamz_id', 'class="inputbox" size="1"', 'id', 'p_name', 0);
	}
