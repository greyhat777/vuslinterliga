...
//print_r($this->_lists['country_reg_rq']);
	...
	function getPCountry($country_id){
		...
		$this->_lists['country'] = JHTML::_('select.genericlist',   $countries, 'country_id', 'class="styled-long '.($this->_lists['country_reg_rq']?" required":"").'" size="1"', 'id', 'country', $country_id );
