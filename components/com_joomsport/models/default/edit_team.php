...
////////UPDATE
	...
	function getPlayersT($id,$s_id){
		...
		if($this->acl == 1){
			$query = "SELECT p.id,CONCAT(p.first_name,' ',p.last_name) as name FROM #__bl_players as p, #__bl_players_team as t WHERE t.player_id=p.id AND t.team_id='".$id."' AND t.season_id=".$s_id." ORDER BY p.first_name,p.last_name";
		}else{
			$query = "SELECT p.id,CONCAT(p.first_name,' ',p.last_name) as name,t.confirmed FROM #__bl_players as p, #__bl_players_team as t WHERE t.player_join='0' AND t.player_id=p.id AND t.team_id='".$id."' AND t.season_id=".$s_id." ORDER BY p.first_name,p.last_name";
		}
		$this->db->setQuery($query);
...
///UOPDATE		
		if($this->acl == 2){
			$query = "SELECT p.id,CONCAT(p.first_name,' ',p.last_name) as name,t.confirmed FROM #__bl_players as p, #__bl_players_team as t WHERE t.player_join='1' AND t.player_id=p.id AND t.team_id='".$id."' AND t.season_id=".$s_id." ORDER BY p.first_name,p.last_name";
			$this->db->setQuery($query);
