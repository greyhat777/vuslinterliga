...
class join_seasonJSModel extends JSPRO_Models
{
	...
	function getcaplist(){
		...
		$this->_lists['cap'] = JHTML::_('select.genericlist',   $cap, 'reg_team', 'class="styled" size="1"', 'id', 't_name', 0 );
	}
	function joinSave(){
	...
	function joinSavePaypl($sid, $is_team,$payment_status,$usr_j,$txn_id,$mc_gross,$payment_date){
		$user	= JFactory::getUser();
	...
	function savePayStatus($reg_team,$user,$s_id){
