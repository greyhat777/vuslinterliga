...
<form action="<?php echo htmlspecialchars(JFactory::getURI()->toString()); ?>" method="post" name="adminForm" id="adminForm">
	<div id="hwd-container"> <a name="top" id="top"></a> 
		...
		<div class="media-header">
			<h2 class="media-media-title"><?php echo JText::sprintf( 'COM_HWDMS_USERXS_ALBUMS', $this->escape($this->channel->title)); ?></h2>
			<!-- View Type -->
			<ul class="media-category-ls">
				...
				<?php if ($canAdd) :?>
				<li><a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=albumform&layout=edit&return='.base64_encode(JFactory::getURI())); ?>" class="ls-add" title="Add Album">Add Album</a> </li>
				<?php endif; ?>
			</ul>
			<div class="clear"></div>
			<!-- Search Filters -->
    ...
    echo $this->loadTemplate('albums_'.$this->display); 
    ?>
		<!-- Pagination -->
