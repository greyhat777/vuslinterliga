...
<div class="media-list-view">
  <table class="category table table-bordered table-striped">
    <thead>
      <tr>
        <th class="list-title" id="tableOrdering1"> <?php  echo JHtml::_('grid.sort', 'COM_HWDMS_ORDER', 'playlist_order', $listDirn, $listOrder) ; ?>
        </th>
    ...
    ?>
      <tr class="<?php echo ($item->published != '1' ? 'system-unpublished ' : false); ?>cat-list-row<?php echo ($counter % 2);?>">
        <td><?php echo $item->playlist_order; ?></td>
        ...
        <td class="list-date"><?php echo JHtml::_('date',$item->created, $this->params->get('global_list_date_format')); ?></td>
