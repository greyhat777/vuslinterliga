<?php
/**
 * @version    SVN $Id: playlists.php 882 2013-01-07 11:53:44Z dhorsfall $
	...
	<div id="hwd-container"> <a name="top" id="top"></a> 
		...
		<div class="media-header">
			<div class="page-header">
				<h2><?php echo JText::_('COM_HWDMS_MY_PLAYLISTS'); ?></h2>
			</div>
		...
		<div class="form-actions">
			<button type="button" class="btn" onclick="Joomla.submitbutton('playlists.delete')"><?php echo JText::_('COM_HWDMS_REMOVE'); ?></button>
			<button type="button" class="btn" onclick="Joomla.submitbutton('playlists.publish')"><?php echo JText::_('COM_HWDMS_PUBLISH'); ?></button>
			<button type="button" class="btn" onclick="Joomla.submitbutton('playlists.unpublish')"><?php echo JText::_('COM_HWDMS_UNPUBLISH'); ?></button>
		</div>
		<!-- Pagination -->
