<?php
/**
 * @version    SVN $Id: subscriptions.php 882 2013-01-07 11:53:44Z dhorsfall $
	...
	<div id="hwd-container"> <a name="top" id="top"></a> 
		...
		<div class="media-header">
			<div class="page-header">
				<h2><?php echo JText::_('COM_HWDMS_MY_SUBSCRIPTIONS'); ?></h2>
			</div>
		...
		<div class="form-actions">
			<button type="button" class="btn" onclick="Joomla.submitbutton('account.unsubscribe')"><?php echo JText::_('COM_HWDMS_UNSUBSCRIBE'); ?></button>
		</div>
		<!-- Pagination -->
