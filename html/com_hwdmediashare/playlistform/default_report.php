...
<div class="edit">
	<form action="<?php echo JRoute::_('index.php?option=com_hwdmediashare'); ?>" method="post" id="adminForm" class="formelm form-horizontal">
		...
		<div class="form-actions">
			<button onclick="Joomla.submitbutton('playlist.report')" type="button" class="btn"><?php echo JText::_('COM_HWDMS_REPORT'); ?></button>
		...
		<div>
			...
			<input type="hidden" name="task" value="playlist.report" />
