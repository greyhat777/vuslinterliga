...
<form action="<?php echo htmlspecialchars(JFactory::getURI()->toString()); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
	<div id="hwd-container"> <a name="top" id="top"></a> 
		...
		<div class="media-header"> 			
			<!-- View Type -->
			<div class="btn-group pull-right"> <a href="<?php echo JRoute::_(hwdMediaShareHelperRoute::getSelfRoute('details')); ?>" class="btn" title="<?php echo JText::_('COM_HWDMS_DETAILS'); ?>"> <i class="icon-file"></i> <?php echo JText::_('COM_HWDMS_DETAILS'); ?></a> <a href="<?php echo JRoute::_(hwdMediaShareHelperRoute::getSelfRoute('list')); ?>" class="btn" title="<?php echo JText::_('COM_HWDMS_LIST'); ?>"> <i class="icon-list"></i> <?php echo JText::_('COM_HWDMS_LIST'); ?></a>
				<?php if ($canAdd) :?>
				<a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=groupform&layout=edit&return='.base64_encode(JFactory::getURI())); ?>" class="btn" title="<?php echo JText::_('COM_HWDMS_ADD_GROUP'); ?>"> <i class="icon-plus"></i> <?php echo JText::_('COM_HWDMS_ADD_GROUP'); ?></a>
				<?php endif; ?>
			</div>
			<div class="page-header">
				<h2><?php echo JText::_('COM_HWDMS_GROUPS'); ?></h2>
			</div>
			<div class="clear"></div>
			<!-- Search Filters -->
			<fieldset class="filters">
				...
				<label><?php echo JText::_('JGLOBAL_DISPLAY_NUM'); ?>&#160; <?php echo $this->pagination->getLimitBox(); ?></label>
				<?php endif; ?>
