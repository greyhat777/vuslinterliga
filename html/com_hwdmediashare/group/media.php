<?php
/**
 * @version    SVN $Id: media.php 882 2013-01-07 11:53:44Z dhorsfall $
 * @package    hwdMediaShare
 * @copyright  Copyright (C) 2012 Highwood Design Limited. All rights reserved.
 * @license    GNU General Public License http://www.gnu.org/copyleft/gpl.html
 * @author     Dave Horsfall
 * @since      11-Jan-2012 11:41:05
 */
...
<form action="<?php echo htmlspecialchars(JFactory::getURI()->toString()); ?>" method="post" name="adminForm" id="adminForm">
  <div id="hwd-container"> <a name="top" id="top"></a>
    ...
    <div class="media-header">
      <h2 class="media-media-title"><?php echo JText::sprintf( 'COM_HWDMS_GROUPXS_MEDIA', $this->escape($this->group->title)); ?></h2>
      <!-- View Type -->
    ...
    echo $this->loadTemplate($this->display);
    ?>
    <!-- Pagination -->
