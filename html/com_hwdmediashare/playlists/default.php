	...
	<div id="hwd-container"> <a name="top" id="top"></a> 
		...
		<div class="media-header"> 
			...
			<div class="pull-right btn-group"> <a href="<?php echo JRoute::_(hwdMediaShareHelperRoute::getSelfRoute('details')); ?>" class="btn" title="<?php echo JText::_('COM_HWDMS_DETAILS'); ?>"> <i class="icon-file"></i> <?php echo JText::_('COM_HWDMS_DETAILS'); ?></a> <a href="<?php echo JRoute::_(hwdMediaShareHelperRoute::getSelfRoute('list')); ?>" class="btn" title="<?php echo JText::_('COM_HWDMS_LIST'); ?>"> <i class="icon-list"></i> <?php echo JText::_('COM_HWDMS_LIST'); ?></a>
				<?php if ($canAdd) :?>
				<a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=playlistform&layout=edit&return='.base64_encode(JFactory::getURI())); ?>" class="btn" title="<?php echo JText::_('COM_HWDMS_ADD_PLAYLIST'); ?>"> <i class="icon-plus"></i> <?php echo JText::_('COM_HWDMS_ADD_PLAYLIST'); ?></a>
				<?php endif; ?>
			</div>
			<div class="page-header">
				<h2><?php echo JText::_('COM_HWDMS_PLAYLISTS'); ?></h2>
			</div>
			<div class="clear"></div>
			<!-- Search Filters -->
