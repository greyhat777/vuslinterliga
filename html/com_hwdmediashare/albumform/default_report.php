...
<div class="edit">
	<form action="<?php echo JRoute::_('index.php?option=com_hwdmediashare'); ?>" method="post" id="adminForm" class="form-horizontal">
		...
		<div class="form-actions">
			<button onclick="Joomla.submitbutton('album.report')" type="button" class="btn"><?php echo JText::_('COM_HWDMS_REPORT'); ?></button>
		...
		<div>
			...
			<input type="hidden" name="task" value="album.report" />
